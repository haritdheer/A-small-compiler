...
public class Grammar123Parser extends Parser {
	...
	@Override
	public String getGrammarFileName() { return "Grammar123.g4"; }
	...
	public Grammar123Parser(TokenStream input) {
		super(input);
	...
	public static class ProgContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof Grammar123Listener ) ((Grammar123Listener)listener).enterProg(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof Grammar123Listener ) ((Grammar123Listener)listener).exitProg(this);
		}
	}
	...
	public static class StatContext extends ParserRuleContext {
		...
		public TerminalNode NEWLINE() { return getToken(Grammar123Parser.NEWLINE, 0); }
		public TerminalNode ID() { return getToken(Grammar123Parser.ID, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof Grammar123Listener ) ((Grammar123Listener)listener).enterStat(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof Grammar123Listener ) ((Grammar123Listener)listener).exitStat(this);
		}
	}
	...
	public static class ExprContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof Grammar123Listener ) ((Grammar123Listener)listener).enterExpr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof Grammar123Listener ) ((Grammar123Listener)listener).exitExpr(this);
		}
	}
	...
	public static class MultExprContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof Grammar123Listener ) ((Grammar123Listener)listener).enterMultExpr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof Grammar123Listener ) ((Grammar123Listener)listener).exitMultExpr(this);
		}
	}
	...
	public static class AtomContext extends ParserRuleContext {
		...
		public TerminalNode INT() { return getToken(Grammar123Parser.INT, 0); }
		public TerminalNode ID() { return getToken(Grammar123Parser.ID, 0); }
		public ExprContext expr() {
			return getRuleContext(ExprContext.class,0);
		}
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof Grammar123Listener ) ((Grammar123Listener)listener).enterAtom(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof Grammar123Listener ) ((Grammar123Listener)listener).exitAtom(this);
		}
	}
